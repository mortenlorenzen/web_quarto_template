...
- Quarto Lightbox extension
- Image carousel with the {slickR} package
...
The below demonstrates placing images with same sizes in 5 columns in a gallery. 
...
The below demonstrates placing images with same sizes in one row in a gallery. 
...
The below demonstrates placing images with different sizes in one row in a gallery. 
